...
public class AnniversaryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvText = v.findViewById(R.id.tvAnniversary);
        btnEdit = v.findViewById(R.id.btnFragAnn);
    ...
    public void onResume() {
        ...
        String item = sharedPreferences.getString("ann","");
        tvText.setText(item);
    }
    ...
    public void onPause() {
        ...
        editor.putString("ann",tvText.getText().toString());
        editor.commit();
    }
}